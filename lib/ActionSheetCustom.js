...
class ActionSheet extends React.Component {
  ...
  componentDidMount () {
    this.state.overlayOpacity.addListener(({value}) => this.setState({value: value}))
  }
  ...
  render () {
    const styles = this.styles
    const { visible, sheetAnim, overlayOpacity } = this.state
    return (
      ...
      >
        <View style={[styles.wrapper]}>
          <Text
            style={[styles.overlay, {opacity: parseFloat(JSON.stringify(overlayOpacity))}]}
